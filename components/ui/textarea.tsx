    ...
    <div className="relative">
      ...
      <textarea
        ...
        className={cn(
          ...
          "dark:bg-input/30 flex field-sizing-content min-h-16 w-full rounded-none border-2 bg-transparent px-3 py-2 text-base shadow-xs",
          "transition-[color,box-shadow] outline-none focus-visible:ring-[3px]",
          "break-all disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
